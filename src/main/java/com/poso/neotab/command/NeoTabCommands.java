...
import com.poso.neotab.network.packet.OpenConfigScreenPacket;
import com.poso.neotab.network.packet.OpenCustomizeScreenPacket;
...
public final class NeoTabCommands {
    ...
    private static int openConfigScreen(CommandSourceStack source) {
        ...
        NeoTabNetwork.INSTANCE.send(PacketDistributor.PLAYER.with(() -> player), 
            new OpenConfigScreenPacket(config));
